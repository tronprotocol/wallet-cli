...
//  }
    ...
    public static Optional<Transaction> getTransactionOnFullNodeById(String txID) {
        return rpcCli.getTransactionOnFullNodeById(txID);
    }

    public static Optional<TransactionList> getTransactionByLimitPrev(String txID, long num) {
        return getTransactionByLimitPrev(txID, num);
    }
}
