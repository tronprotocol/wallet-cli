...
//  }
  ...
  public TransactionExtention updateSettingForEnergyLimit(
      Contract.UpdateSettingForEnergyLimitContract request) {
    return blockingStubFull.updateSettingForEnergyLimit(request);
  }
