...
public class EasyTransferByPrivateDemo {
  ...
  public static void main(String[] args) {
    ...
    EasyTransferResponse response = WalletClient.easyTransferByPrivate(ByteArray.fromHexString(privateKey), WalletClient.decodeFromBase58Check(toAddress), 1000000L);
