...
public class AddressChannelFactory implements GrpcChannelFactory {
  ...
  public AddressChannelFactory(GrpcChannelsProperties properties, LoadBalancer.Factory
      loadBalancerFactory, GlobalClientInterceptorRegistry globalClientInterceptorRegistry) {
