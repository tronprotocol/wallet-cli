...
//  }
  ...
  public static void testGenerateWalletFile() throws CipherException, IOException {
    ...
    CredentialsEckey credentialsEckey = WalletUtils.loadCredentials(PASSWORD.getBytes(), new File(file, fileName));
    String address = credentialsEckey.getAddress();
    ECKey ecKeyPair = credentialsEckey.getEcKeyPair();
