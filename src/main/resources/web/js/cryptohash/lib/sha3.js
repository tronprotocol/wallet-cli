...
(function (L) {
  function u(d, b, h) {
    var c = 0, a = [], l = 0, e, m, r, g, k, f, p, v, A = !1, n = [], u = [], w,
        z = !1, x = !1, t = -1;
    h = h || {};
    e = h.encoding || "UTF8";
    w = h.numRounds || 1;
    ...
    this.setHMACKey = function (a, b, l) {
      ...
      l = h / 4 - 1;
      if (h < a / 8) {
        for (b = p(b, a, 0, y(d), g); b.length <= l;) {
          b.push(0);
        }
        b[l] &= 4294967040
      } else if (h > a / 8) {
    ...
    this.getHash = function (e, b) {
      ...
      for (f = 1; f < w; f += 1) {
        !0 === x && 0 !== g % 32 && (k[k.length
        - 1] &= 16777215 >>> 24 - g % 32), k = p(k, g, 0, y(d), g);
      }
      return h(k)
    };
  ...
  function F(d,
    ...
    for (l = 0; l < b; l += 1) {
      e = d[l >>> 2] >>> 8 * (m + l % 4
          * h), a += "0123456789abcdef".charAt(e >>> 4 & 15)
  ...
  function G(d, b, h, c) {
    ...
    g = -1 === h ? 3 : 0;
    for (e = 0; e < l; e += 3) {
      for (m = e + 1 < l ? d[e + 1 >>> 2] : 0, f = e
      + 2 < l ? d[e + 2 >>> 2] : 0, f = (d[e >>> 2] >>> 8 * (g + e % 4 * h)
          & 255)
          << 16 | (m >>> 8 * (g + (e + 1) % 4 * h) & 255) << 8 | f >>> 8 * (g
              + (e
                  + 2) % 4 * h) & 255, m = 0; 4 > m; m += 1) {
        8 * e + 6 * m <= b
  ...
  function D(d, b, h) {
    ...
    switch (d) {
      ...
      case "TEXT":
        d = function (c, a, d) {
          var e, m, f = 0, g, k, q, p, v, n;
          a = a || [0];
          d = d || 0;
          q = d >>> 3;
          if ("UTF8" === b) {
            for (n = -1 === h ? 3 : 0, g = 0; g < c.length;
                g += 1) {
              for (e = c.charCodeAt(g), m = [], 128 > e ? m.push(e)
                  : 2048 > e ? (m.push(192 | e >>> 6), m.push(128 | e & 63))
                      : 55296 > e || 57344 <= e ? m.push(224 |
                          e >>> 12, 128 | e >>> 6 & 63, 128 | e & 63)
                          : (g += 1, e = 65536 + ((e & 1023) << 10
                              | c.charCodeAt(
                                  g) & 1023), m.push(240 | e >>> 18, 128 | e
                              >>> 12
                              & 63, 128 | e >>> 6 & 63, 128 | e & 63)), k = 0;
                  k < m.length; k += 1) {
                v = f + q;
                for (p = v >>> 2; a.length <= p;) {
                  a.push(0);
                }
                a[p] |= m[k] << 8 * (n + v % 4 * h);
                f += 1
            ...
            for (n = -1 === h ? 2
                : 0, m = "UTF16LE" === b && 1 !== h || "UTF16LE" !== b && 1
                === h, g = 0; g < c.length; g += 1) {
              e = c.charCodeAt(g);
      ...
      case "BYTES":
        d = function (c, a, b) {
          ...
          for (d = 0; d < c.length; d += 1) {
            e = c.charCodeAt(d), k = d
                + f, g = k >>> 2, a.length <= g && a.push(0), a[g] |= e << 8
                * (n
                    + k % 4 * h);
          }
      ...
      case "ARRAYBUFFER":
        ...
        d = function (c, a, b) {
          ...
          for (d = 0; d < c.byteLength; d += 1) {
            g = d + f, n = g >>> 2, a.length
            <= n && a.push(0), a[n] |= q[d] << 8 * (k + g % 4 * h);
          }
  ...
  function z(d, b) {
    return 32 < b ? (b -= 32, new f(d.b << b | d.a >>> 32 - b, d.a << b | d.b
        >>> 32 - b)) : 0 !== b ? new f(d.a << b | d.b >>> 32 - b, d.b << b | d.a
        >>> 32 - b) : d
  }
  ...
  function y(d) {
    var b = [];
    if (0 === d.lastIndexOf("SHA3-", 0) || 0 === d.lastIndexOf("SHAKE",
            0)) {
      for (d = 0; 5 > d; d += 1) {
        b[d] =
            [new f(0, 0), new f(0, 0), new f(0, 0), new f(0, 0),
              new f(0, 0)];
      }
    } else {
  ...
  function B(d, b) {
    ...
    for (h = 0; 24 > h; h += 1) {
      ...
      for (c = 0; 5 > c; c += 1) {
        a = b[c][0];
        var r = b[c][1], g = b[c][2], k = b[c][3], q = b[c][4];
        e[c] = new f(a.a ^ r.a ^ g.a ^ k.a ^ q.a, a.b ^ r.b ^ g.b ^ k.b ^ q.b)
      }
      for (c = 0; 5 > c; c += 1) {
        m[c] = n(e[(c + 4) % 5], z(e[(c + 1) % 5], 1));
      }
      for (c = 0; 5 > c; c += 1) {
        for (a = 0; 5 > a; a += 1) {
          b[c][a] =
      ...
      for (c = 0; 5 > c; c += 1) {
        for (a = 0; 5 > a; a += 1) {
          b[c][a] = n(l[c][a],
              new f(~l[(c + 1) % 5][a].a & l[(c + 2) % 5][a].a, ~l[(c + 1)
                  % 5][a].b
                  & l[(c + 2) % 5][a].b));
        }
      }
  ...
  var J, K;
  K = [new f(0, 1), new f(0, 32898), new f(2147483648, 32906),
    new f(2147483648, 2147516416), new f(0, 32907), new f(0, 2147483649),
    new f(2147483648, 2147516545), new f(2147483648, 32777), new f(0, 138),
    new f(0, 136), new f(0, 2147516425), new f(0, 2147483658),
    new f(0, 2147516555),
    new f(2147483648, 139), new f(2147483648, 32905), new f(2147483648, 32771),
    new f(2147483648, 32770), new f(2147483648, 128), new f(0, 32778),
    new f(2147483648, 2147483658), new f(2147483648, 2147516545),
    new f(2147483648, 32896), new f(0, 2147483649),
    new f(2147483648, 2147516424)];
  J = [[0, 36, 3, 41, 18], [1, 44, 10, 45, 2], [62, 6, 43, 15, 61],
    [28, 55, 25, 21, 56], [27, 20, 39, 8, 14]];
  "function" === typeof define && define.amd ? define(function () {
    return u
  }) : "undefined" !== typeof exports ? ("undefined" !== typeof module
  && module.exports && (module.exports =
      u), exports = u) : L.jsSHA = u
})(this);