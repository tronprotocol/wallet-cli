...
(function (G) {
  function r(d, b, c) {
    var h = 0, a = [], f = 0, g, m, k, e, l, p, q, t, w = !1, n = [], u = [], v,
        r = !1;
    c = c || {};
    g = c.encoding || "UTF8";
    v = c.numRounds || 1;
  ...
  function C(d, b, c) {
    ...
    for (a = 0; a < b; a += 1) {
      f = d[a >>> 2] >>> 8 * (3 + a % 4
          * -1), h += "0123456789abcdef".charAt(f >>> 4 & 15)
  ...
  function D(d, b, c) {
    var h = "", a = b / 8, f, g, m;
    for (f = 0; f < a; f += 3) {
      for (g = f + 1 < a ? d[f + 1 >>> 2] : 0, m = f
      + 2 < a ? d[f + 2 >>> 2] : 0, m = (d[f >>> 2] >>> 8 * (3 + f % 4 * -1)
          & 255) << 16 | (g >>> 8 * (3 + (f + 1) % 4 * -1) & 255) << 8 | m >>> 8
          * (3 + (f + 2) % 4 * -1) & 255, g = 0; 4 > g; g += 1) {
        8 * f + 6 * g <= b
            ? h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m
            >>>
            6 * (3 - g) & 63) : h += c.b64Pad;
      }
    }
    ...
    switch (d) {
      ...
      case "TEXT":
        c = function (c, a, f) {
          ...
          p = f >>> 3;
          if ("UTF8" === b) {
            for (n = 3, e = 0; e < c.length;
                e += 1) {
              for (g = c.charCodeAt(e), d = [], 128 > g ? d.push(g)
                  : 2048 > g ? (d.push(192 | g >>> 6), d.push(128 | g & 63))
                      : 55296 > g || 57344 <= g ? d.push(224 | g >>> 12, 128 | g
                          >>> 6 & 63, 128 | g & 63) : (e += 1, g = 65536 + ((g
                          & 1023) << 10 | c.charCodeAt(e) & 1023), d.push(240
                          | g
                          >>> 18, 128 | g >>> 12 & 63, 128 | g >>> 6 & 63, 128
                          | g
                          & 63)), l = 0; l < d.length; l += 1) {
                t = k +
                    p;
          ...
          } else if ("UTF16BE" === b || "UTF16LE"
              === b) {
            for (n = 2, d = "UTF16LE" === b && !0 || "UTF16LE" !== b
      ...
      case "BYTES":
        c = function (b, a, c) {
          ...
          for (m = 0; m < b.length; m +=
              1) {
            d = b.charCodeAt(m), l = m + k, e = l >>> 2, a.length <= e
            && a.push(0), a[e] |= d << 8 * (3 + l % 4 * -1);
          }
      ...
      case "ARRAYBUFFER":
        ...
        c = function (b, a, c) {
          ...
          for (d = 0; d < b.byteLength; d += 1) {
            e = d + m, k = e >>> 2, a.length
            <= k && a.push(0), a[k] |= l[d] << 8 * (3 + e % 4 * -1);
          }
  ...
  function y(d, b, c, h, a) {
    ...
    return ((d >>> 16) + (b >>> 16) + (c >>> 16) + (h >>> 16) + (a >>> 16) + (f
        >>> 16) & 65535) << 16 | f & 65535
  }
  ...
  function x(d) {
    var b = [];
    if ("SHA-1" === d) {
      b = [1732584193, 4023233417, 2562383102, 271733878,
        3285377520];
    } else {
  ...
  function z(d, b) {
    ...
    m = b[4];
    for (e = 0; 80 > e; e += 1) {
      c[e] = 16 > e ? d[e] : n(c[e - 3] ^ c[e - 8]
          ^ c[e - 14] ^ c[e - 16], 1), k = 20 > e ? y(n(h, 5), a & f ^ ~a & g,
          m,
          1518500249, c[e]) : 40 > e ? y(n(h, 5), a ^ f ^ g, m, 1859775393,
          c[e])
          : 60 > e ? y(n(h, 5), a & f ^ a & g ^ f & g, m, 2400959708, c[e]) : y(
              n(h, 5), a ^ f ^ g, m, 3395469782, c[e]), m = g, g = f, f = n(a,
          30), a = h, h = k;
    }
    b[0] = u(h, b[0]);
    b[1] = u(a, b[1]);
  ...
  && module.exports && (module.exports = r), exports = r) : G.jsSHA = r
})(this);
