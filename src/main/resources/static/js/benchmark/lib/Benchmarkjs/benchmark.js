...
;(function() {
    ...
    /**
     * Create a new `Benchmarkjs` function using the given `context` object.
     *
     * @static
     * @memberOf Benchmark
     * @param {Object} [context=root] The context object.
     * @returns {Function} Returns a new `Benchmarkjs` function.
     */
    function runInContext(context) {
        // Exit early if unable to acquire lodash.
        var _ = context && context._ || require('benchmarking/lib/Benchmarkjs/lodash') || root._;
        if (!_) {
        ...
        /**
         * The Benchmarkjs constructor.
         *
         * Note: The Benchmarkjs constructor exposes a handful of lodash methods to
         ...
         * var bench = new Benchmarkjs(fn);
         *
         * // or using a name first
         * var bench = new Benchmarkjs('foo', fn);
         *
         * // or with options
         * var bench = new Benchmarkjs('foo', fn, {
     *
     *   // displayed by `Benchmarkjs#toString` if `name` is not available
     *   'id': 'xyz',
     *
     ...
     * });
         ...
         * var bench = new Benchmarkjs('foo', function() {
     ...
     * });
         ...
         *
         * // basic usage (the `new` operator is optional)
         * var suite = new Benchmarkjs.Suite;
         *
         * // or using a name first
         * var suite = new Benchmarkjs.Suite('foo');
         *
         * // or with options
         * var suite = new Benchmarkjs.Suite('foo', {
     *
     ...
     * });
         ...
         *
         * // get odd numbers
         * Benchmarkjs.filter([1, 2, 3, 4, 5], function(n) {
     *   return n % 2;
     * }); // -> [1, 3, 5];
         *
         * // get fastest benchmarks
         * Benchmarkjs.filter(benches, 'fastest');
         *
         * // get slowest benchmarks
         * Benchmarkjs.filter(benches, 'slowest');
         *
         * // get benchmarks that completed without erroring
         * Benchmarkjs.filter(benches, 'successful');
         */
         ...
         * Benchmarkjs.invoke(benches, 'reset');
         *
         * // invoke `emit` with arguments
         * Benchmarkjs.invoke(benches, 'emit', 'complete', listener);
         *
         * // invoke `run(true)`, treat benchmarks as a queue, and register invoke callbacks
         * Benchmarkjs.invoke(benches, {
     *
     ...
     * });
        ...
        function invoke(benches, name) {
            ...
            /**
             * Checks if invoking `Benchmarkjs#run` with asynchronous cycles.
             */
     ...
     * });
         ...
         *
         * @memberOf Benchmark, Benchmarkjs.Suite
     ...
     * });
        ...
        function cycle(clone, options) {
            ...
            if (clone.running) {
                // `minTime` is set to `Benchmarkjs.options.minTime` in `clock()`.
                cycles = ++clone.cycles;
        ...
        // The bugginess continues as the `Benchmarkjs` constructor has an argument
        // named `options` and Firefox 1 will not assign a value to `Benchmarkjs.options`,
        ...
        _.assign(Benchmark, {
            ...
            'options': {
                ...
                /**
                 * Displayed by `Benchmarkjs#toString` when a `name` is not available
             ...
             * @type Object
             */
            'platform': context.platform || require('benchmarking/lib/Benchmarkjs/platform') || ({
        ...
        // Add lodash methods to Benchmarkjs.
    ...
    if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
        ...
        define(['benchmarking/lib/Benchmarkjs/lodash', 'lib/Benchmarkjs/platform'], function(_, platform) {
            return runInContext({
                '_': _,
                'platform': platform
            });
