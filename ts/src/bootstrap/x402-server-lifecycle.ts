import type { X402ServerPort, X402ServerHandle, X402ServeInput } from "../application/ports/x402-server.js";
...
export class ManagedX402Server implements X402ServerPort {
  ...
  validate(network: NetworkDescriptor, input: X402ServeInput): void { this.server.validate(network, input); }
