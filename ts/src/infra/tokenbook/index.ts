/**
 * TokenBook (L1, §7.17) — the token address-book: official builtin layer (per network) +
 * user layer (`tokens.json`, per network+account). `effective()` is the union both list-tokens
