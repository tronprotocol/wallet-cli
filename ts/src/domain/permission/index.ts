...
export const TRON_OPERATIONS: readonly TronOperation[] = Object.freeze([
  ...
  { contractTypeId: 3, contractType: "VoteAssetContract", label: "Vote for TRC10 [legacy]" },
  ...
  { contractTypeId: 20, contractType: "CustomContract", label: "Custom Contract [legacy]" },
  ...
  { contractTypeId: 32, contractType: "GetContract", label: "Get Contract [legacy]" },
