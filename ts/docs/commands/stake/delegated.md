...
```bash
wallet-cli stake delegated --direction out --account main --network nile
```
...
Delegations (2)
  ...
  TF9yB7bAL2oBbonYaMvGTqoXxExS14x73c  energy     500 TRX  2026-07-08 08:00 (in ~3 day(s))
  TNDHPk1LMLZTap8tMWfxUBy4MgArnWeSVP  bandwidth  100 TRX  not locked
```

```bash
wallet-cli stake delegated --direction out --account main --network nile -o json
```

```json
{"schema":"wallet-cli.result.v1","success":true,"command":"stake.delegated","data":{"address":"TP2Zs9qKScTMs8jDYV3SAHQ5pqgKY1NQ5V","direction":"out","canDelegateMaxSun":{"energy":"900000000","bandwidth":"300000000"},"delegations":[{"receiver":"TF9yB7bAL2oBbonYaMvGTqoXxExS14x73c","resource":"energy","amountSun":"500000000","lockedUntil":1783468800000},{"receiver":"TNDHPk1LMLZTap8tMWfxUBy4MgArnWeSVP","resource":"bandwidth","amountSun":"100000000","lockedUntil":null}]},"meta":{"durationMs":28,"warnings":[]},"chain":{"family":"tron","network":"tron:3448148188","chainId":"3448148188"}}
```

Inbound (`--direction in`) — the lock column becomes `Guaranteed until`, no Max delegatable:

```bash
wallet-cli stake delegated --direction in --account main --network nile
```
